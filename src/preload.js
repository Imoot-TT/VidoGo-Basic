...
contextBridge.exposeInMainWorld('mediaDeck', {
  ...
  getAnalyticsState: () => ipcRenderer.invoke('analytics:get-state'),
  setAnalyticsConsent: (enabled) => ipcRenderer.invoke('analytics:set-consent', enabled),
  trackAnalytics: (event, properties = {}) => ipcRenderer.invoke('analytics:track', { event, properties }),
  ...
  getRememberedLogin: () => ipcRenderer.invoke('account:get-remembered-login'),
  saveRememberedLogin: (credentials) => ipcRenderer.invoke('account:save-remembered-login', credentials),
  clearRememberedLogin: () => ipcRenderer.invoke('account:clear-remembered-login'),
  ...
  setMediaLibraryProjectTags: (projectKey, tags) => ipcRenderer.invoke('library:set-project-tags', { projectKey, tags }),
