  ...
  : (scenario === 'recorder-flow'
    ...
    : (scenario === 'manifest-flow'
      ...
      : (scenario === 'dash-flow'
        ...
        : (scenario === 'browser-youtube-flow' ? 'vidogo-smoke-youtube.png' : 'vidogo-smoke-home.png')))));
...
const timeoutMs = ['browser-youtube-flow', 'download-queue-real'].includes(scenario)
  ? 90000
