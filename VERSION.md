...
- 产品名称：**VidoGo Basic**
- 源码版本：**0.2.0**
- GitHub Release 标签：**`basic-v0.2.0`**
- Windows 安装包：**`VidoGo-Basic-0.2.0-x64-Setup.exe`**

`0.1.0` 是 Basic 产品线的首个公开开发版本；后续 `0.1.x` 用于兼容性和平台支持修复。`0.x` 表示产品仍在开发阶段；产品达到首个稳定版本时再升级为 `1.0.0`。

`0.1.9` 是首个内置自动更新器的 Basic 版本。`0.2.0` 将产品主任务收敛为“一个链接生成一个完整素材包”，并进入创作者封闭验证阶段。

## 产品线命名

| 产品线 | 应用内显示 | Release 标签 | 安装包示例 |
| --- | --- | --- | --- |
| Basic | `VidoGo Basic 0.2.0` | `basic-v0.2.0` | `VidoGo-Basic-0.2.0-x64-Setup.exe` |
